...
```
```
官方自带snpe-net-run推理(使用的是dlc)测试gpu最强
```
...
<img width="400"  alt="11b6523b95857082909014e487c80c5f" src="https://github.com/user-attachments/assets/7145d5f1-b9f8-463d-95f1-182644b79663" />
...
ndk-aarch64-linux:
https://github.com/SnowNF/ndk-aarch64-linux/releases
```
